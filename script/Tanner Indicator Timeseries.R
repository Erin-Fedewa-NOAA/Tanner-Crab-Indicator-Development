...
size <- read_csv("./output/size_at_term_molt.csv") #Contributor: Jon Richar
...
size %>%
  ...
  theme_bw() +
  labs(x="", y = "Size at 50% probability of terminal molt (mm)")
ggsave(path = "./figs", "Size_at_term_molt.png")
