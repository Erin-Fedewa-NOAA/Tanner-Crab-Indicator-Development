...
# Calculate visual prevalence of BCD in Tanner crab
  #Prevalance estimates are expanded by area swept abundance 
...
#compute cpue by disease code 2 for mature crab only
  #Using Tanner W male cutline for now, but need to revise to using annual size at 50%
  #as cutline in future iterations
